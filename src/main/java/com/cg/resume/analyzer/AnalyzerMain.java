...
public class AnalyzerMain {
	...
	String  filePath = "C:\\Users\\sphulari\\Downloads\\resume\\143642_ShwetaNagraj_JAVA_resume.doc";
	...
	private void processDocument(String filePath) {
		...
		try {
			...
			XWPFDocument document = AnalyzerUtil.readDocxDocument(filePath); // reading word document
